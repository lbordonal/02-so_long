...
/*   Updated: 2023/08/28 12:10:20 by lbordona         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	exit_game(t_game *game)
{
	...
	mlx_destroy_image(game->mlx, game->img_enemy_w);
	mlx_destroy_image(game->mlx, game->img_enemy_a);
	mlx_destroy_image(game->mlx, game->img_enemy_s);
	mlx_destroy_image(game->mlx, game->img_enemy_d);
